...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	SessionManager::login("nandyala", $user_login_id,  $password);
}
else if(isset($_SESSION['password'])&&isset($_SESSION['mobile_no'] ))
{	
	SessionManager::login("nandyala", $_SESSION['mobile_no'],  $_SESSION['password'] );
}
...
<head>
	...
	<link href="nandyala.css" rel="stylesheet">
