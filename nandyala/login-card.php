    ...
    <div class="row d-flex justify-content-center mt-3 p-0 m-0 p-3 ">
        <div class="col-xl-4 col-md-8 col-sm-10 shadow rounded border bg-body-tertiary" >
            <div class="d-flex justify-content-center w-100 mt-3">
                <div class="d-flex justify-content-center rounded-circle p-3 border bg-body circle-logo1">
                    <img id="" src="<?php echo BASE_PATH;?>assets\photos\client\nandyala\nandyala-client-logo.png" alt="Logo" />
                </div>
            </div>
