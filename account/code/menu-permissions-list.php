...
$permissionVariables = $_SESSION['menu_permission_variables'];  // Example: "on_off_control, on_off_mode, device_info_update"
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['user_id'])) {
	...
	$query = "SELECT $permissionVariables FROM menu_permissions_list WHERE login_id = ?";
