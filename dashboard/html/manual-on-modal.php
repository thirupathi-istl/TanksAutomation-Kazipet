<div class="modal fade" id="manualOnModal" tabindex="-1" aria-labelledby="manualOnModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="manualOnModalLabel">Manual ON Devices</h5>
                ...
                <div class="col-12 p-0">
                    <div class="table-responsive-1 rounded mt-2 border ">
                        <table class="table table-striped table-type-1 w-100 text-center">
                         ...
                         <tbody id="manual_on_devices_table">
