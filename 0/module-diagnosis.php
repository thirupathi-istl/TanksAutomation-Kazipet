    ...
    <div class="container-fluid">
        <div class="row d-flex align-items-center">
            <div class="col-12 p-0">
                <p class="m-0 p-0"><span class="text-body-tertiary">Pages / </span><span>Modules Diagnosis</span></p>
            </div>
        </div>
            ...
            <div class="col-12 p-0">
                    ...
                    <div class="row justify-content-end align-items-center">
                        <div class="col-auto d-flex align-items-center flex-wrap">
                            <div class="form-group d-flex align-items-center mb-2  ps-3 ">
                                ...
                                <select class="form-select mx-2" id="selecting_paramter">
                                    <option value="MODULES">Modules</option>
                                    <option value="SIM-DIAGNOSIS">SIM Diagnosis</option>                                
                                    <option value="SIM-MODULE-FAIL">SIM-Module-Fail</option>   
                                    <option value="SIM-MODULE-REMOVAL">SIM-Module-Removal</option> 
                                    <option value="BOX-TOP-COVER-OPEN-CLOSE">Box-Top-Cover-Activity</option>                           
                ...
                <div  class="table-container">
                    <div class="table-responsive rounded mt-2 border">
                        <table id="diagnosis_table" class="table table-striped table-bordered table-hover table-type-1 table-sticky-header w-100">
...
<script src="<?php echo BASE_PATH;?>assets/js/project/module-diagnosis.js"></script>
<script>
